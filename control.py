...
TOKEN = '8325797507:AAF_0ePuL5zdoVwoO_kH2AjGPJ2fkh35BPY'  
...
try:
    bot.send_message('Manipalhebbal_Bot', '✅ Connection established!')  # Updated chat ID
...
def send_screen(message):
    ...
    os.remove(image_path)  # Clean up the screenshot file
